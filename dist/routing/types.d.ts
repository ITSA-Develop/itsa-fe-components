...
type RoutePathsType = {
    path: RoutesPathsProp | RoutesPathsProp[];
};
export type ProtectedRouteProps = RouteProps & ProtectedType & RoutePathsType & {
    component: ReactNode;
};
export type PublicRouteProps = RouteProps & RoutePathsType & {
    component: ReactNode;
};
