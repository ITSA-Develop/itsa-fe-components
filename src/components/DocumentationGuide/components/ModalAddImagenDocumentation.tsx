...
export const ModalAddImagenDocumentation = ({ onUpload, fileList, maxImages = MAX_IMAGES, loading = false }: IModalAddImagenDocumentationProps) => {
    
    const { imageKey } = useUploadImages();
    ...
    const handleCopyKey = async () => {
        ...
        await navigator.clipboard.writeText(imageKey);
            ...
            {imageKey && (
                <div className="mt-4 rounded-md border border-green-200 bg-green-50 p-3">
                    ...
                    >
                        ...
                        <span className="block truncate font-mono">{imageKey}</span>
                    </button>
                </div>
            )}
        </div>
