...
export const HEADER_SELECT_CLASSNAME =
	'w-full min-w-0 [&_.ant-select-selector]:!bg-primary-600 [&_.ant-select-selector]:!border-primary-700 [&_.ant-select-selector]:!shadow-none [&_.ant-select-selection-item]:!text-white-100 [&_.ant-select-selection-item]:!block [&_.ant-select-selection-item]:!min-w-0 [&_.ant-select-selection-item]:!max-w-full [&_.ant-select-selection-item]:!truncate [&_.ant-select-selection-item-content]:!block [&_.ant-select-selection-item-content]:!max-w-full [&_.ant-select-selection-item-content]:!truncate [&_.ant-select-selection-placeholder]:!text-white-100 [&_.ant-select-arrow]:!text-white-100 hover:[&_.ant-select-selector]:!bg-primary-700 hover:[&_.ant-select-selector]:!border-primary-700 [&.ant-select-focused_.ant-select-selector]:!bg-primary-700 [&.ant-select-focused_.ant-select-selector]:!border-primary-700';
...
export const SELECT_WRAPPER_STYLE = {
	width: 'clamp(160px, calc((100vw - 280px) / 3), 256px)',
} as const;
export const MOBILE_SELECT_WRAPPER_CLASSNAME = 'block min-w-0 shrink-0 md:hidden';
export const MOBILE_SELECT_WRAPPER_STYLE = { width: 84 } as const;
